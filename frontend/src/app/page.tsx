        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Akıllı Alertler</h3>
              <p className="text-gray-600">
            ...
            <div className="card text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Detaylı Raporlar</h3>
              <p className="text-gray-600">
            ...
            <div className="card text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">KVKK Uyumlu</h3>
              <p className="text-gray-600">
